...
This information is sourced from the RFC: 0002 previously in the RST RFC documentation.  For the filenaming convention, it is expected the Data Standards Working Group documentation will make information presented here obsolete.
