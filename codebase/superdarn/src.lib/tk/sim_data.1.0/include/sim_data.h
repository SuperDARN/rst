...
void acf_27(double complex double * aa, double complex double * rr, int cpid);
void sim_data(double *t_d, double *t_g, double *t_c, double *v_dop, int * qflg,
              ...
              double dt, double complex double * out_samples, double complex double ** out_acfs, int decayflg);
