    ...
    for (c=0;c<dmap.anum;c++) {
	   ...
	   flag=true;
         ...
         if ((arr.name.equals("v_e")) && (arr.type==DataMap.DATAFLOAT) &&
           ...
           System.err.println(arr.name+" = ");
	   for (x=0;x<arr.rng[0];x++) System.err.println(rng[slist[x]].v_err);
	   flag=true;
	 }  
	   ...
	   flag=true;
         ...
         if ((arr.name.equals("sd_l")) && (arr.type==DataMap.DATAFLOAT) &&
           ...
           System.err.println(arr.name+" = ");
	   for (x=0;x<arr.rng[0];x++) System.err.println(rng[slist[x]].sdev_l);
	   flag=true;
	 }  
         ...
         if ((arr.name.equals("sd_s")) && (arr.type==DataMap.DATAFLOAT) &&
           ...
           System.err.println(arr.name+" = ");
	   for (x=0;x<arr.rng[0];x++) System.err.println(rng[slist[x]].sdev_s);
	   flag=true;
	 }
	   ...
	   flag=true;
         ...
         if ((arr.name.equals("x_qflg")) && (arr.type==DataMap.DATACHAR) &&
           ...
           System.err.println(arr.name+" = ");
	   for (x=0;x<arr.rng[0];x++) System.err.println(xrng[slist[x]].qflg);
	   flag=true;
	 }   
