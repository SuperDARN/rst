...
public class FFTAppWindow extends CloseFrame implements ActionListener {
  ...
  public FFTAppWindow(String hosts,String ports,String names) {
    int i=0,j=0,k=0,l=0;
    Button open=null;
   
    if (hosts==null) hosts=new String("209.128.50.18");	
    if (ports==null) ports=new String("1026");
