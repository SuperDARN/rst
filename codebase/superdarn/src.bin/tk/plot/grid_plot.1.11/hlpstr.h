...
"-new\tthe input file is in grdmap format.\n",
...
"-vecccol aarrggbb\tif a colorkey is not used then set the color of vectors aarrggbb, specified as the hexadecimal value for the 32-bit alpha,red,green and blue component color.\n",
...
"gridname\tfilename of the grid format file to plot.\n",
