...
int main(int argc,char *argv[]) {
  ...
  RplotMakeDocument(rplot,"PolygonRead","1",wdt,hgt,24);   
  RplotMakePlot(rplot,"PolygonRead",wdt,hgt,24);
  ...
  for (i=0;i<poly->polnum;i++) {
    ...
    if (type==1) fgcol=RplotColor(0,255,0,255);
    if (type==2) fgcol=RplotColor(255,255,255,255);
